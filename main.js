...
const renderShipHoriz = (squareID,squaresToStyle,shipID) =>{
    ...
    if(!(0,_handleStylingEventsData__WEBPACK_IMPORTED_MODULE_0__.isPlacementValid)(elementToStyle,squaresToStyle)) return
